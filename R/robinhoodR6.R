#Required packages
# c("jsonlite","XML","xml2","httr","R6","plyr","quantmod")
Login <- R6::R6Class(
...
rh_order_history <- function(account) {
  ...
  total_equity<-as.numeric(account$get_day_PnL()$Equity)
...
# rh_getOptions<-function(account,symbol,expiration_dates,option_type){
#   header<-account$user$authHeader
